...
export default function RegistrationCard({ type, title, description, icon, bgColor }) {
    return (
        <div className={`p-6 rounded-lg ${bgColor} transition-transform hover:scale-105 cursor-pointer`}>
